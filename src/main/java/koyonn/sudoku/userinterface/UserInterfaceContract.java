...
/**
 * Родительский интерфейс выступает как пространство имен множества компонентов
 * пользовательского интерфейса
 */
public interface UserInterfaceContract {
	/**
	 * EventListener выступает в качестве контроллера пользовательского
	 * графического интерфейса. Он получает событие, вызванное действиями
	 * пользователя, обрабатывает его и передает во внутреннюю часть программы.
	 */
