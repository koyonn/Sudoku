...
/**
 * Control logic class. Управляет действиями между пользователем, графическим интерфейсом и бекэндом.
 * В данном случае мы общаемся с View
 */
public class ControlLogic implements UserInterfaceContract.SudokuEventListener {
    ...
    public void onSudokuInput(int x, int y, int input) {
        try {
            ...
            // Создаем массив судоку и передаем ему текущее состояние сетки судоку
            int[][] newGridState = gameData.getCopyOfGridState();
            // Присваиваем только что введенное значение по заданным координатам
            newGridState[x][y] = input;
            // Создаем массив судоку, который представляет собой состояние сетки судоку на начало игровой сессии
